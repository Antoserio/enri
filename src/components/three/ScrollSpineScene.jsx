...
export default function ScrollSpineScene({ projects, onScreenClick }) {
  ...
  useEffect(() => {
    ...
    projects.forEach((project, i) => {
      ...
      const sideOffset = isPortrait ? 1.5 : 3.2;
      ...
      // Screen plane
      const screenW = isPortrait ? 0.65 : 3.4;
      const screenH = isPortrait ? 0.9 : 1.9;
      ...
      // Frame glow
      const frameW = isPortrait ? 0.75 : 3.7;
      const frameH = isPortrait ? 1.0 : 2.2;

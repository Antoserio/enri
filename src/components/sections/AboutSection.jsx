      ...
      <div className="px-[5vw] md:px-[10vw]">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16">
          ...
          >
            ...
            <p className="text-white/50 font-body font-light text-lg leading-relaxed max-w-3xl" style={{ lineHeight: 1.6 }}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16 pt-16 border-t border-white/10">
              {[
                ...
                >
                  ...
                  <p className="text-sm text-white/30 font-body mt-1">{stat.label}</p>
                </motion.div>
              ))}
            </div>
          </motion.div>

...
const translations = {
  es: {
    ...
    about: {
      ...
      bio: "Enri La Forêt es músico de formación clásica, residente en Madrid. Actualmente enfocado en la producción musical electrónica, su campo de creación se basa en la experimentación y búsqueda de lugares de encuentro entre sonoridades múltiples y otros lenguajes —imagen, texto, voz o artes vivas— para construir dispositivos artísticos desde los que explorar narrativas disidentes.\n\nHa sido residente en el Centro de Arte y Tecnología Etopia de Zaragoza y ha llevado varias performances y directos, en colaboración con otrxs artistas, a La Casa Encendida, el Museo Reina Sofía, Cruce Contemporáneo, el Teatro del Barrio y el Festival Poetas, entre otros. También ha compuesto música para obras de teatro y ha sido creador de espacios sonoros para centros como CaixaForum o Matadero de Madrid.\n\nEn 2025 estrena Espacio Premeditadamente Vacío, un proyecto dual y su primero en solitario como compositor. Está integrado por un Live/AV y un LP publicado en marzo de 2026 en digital y en vinilo con el sello Pinorama Records.\n\nActualmente continúa investigando sonoridades y temáticas para la composición de su segundo álbum, al tiempo que realiza colaboraciones y producciones musicales con diferentes artistas.",
  ...
  en: {
    ...
    about: {
      ...
      bio: "Enri La Forêt is a classically trained musician based in Madrid. Currently focused on electronic music production, his field of creation is based on experimentation and the search for meeting points between multiple sonorities and other languages —image, text, voice or live arts— to build artistic devices from which to explore dissident narratives.\n\nHe has been a resident at the Centro de Arte y Tecnología Etopia in Zaragoza and has brought several performances and live sets, in collaboration with other artists, to La Casa Encendida, the Museo Reina Sofía, Cruce Contemporáneo, the Teatro del Barrio and the Festival Poetas, among others. He has also composed music for theatre productions and created sound environments for venues such as CaixaForum and Matadero de Madrid.\n\nIn 2025 he premieres Espacio Premeditadamente Vacío, a dual project and his first as a solo composer. It comprises a Live/AV and an LP released in March 2026 in digital and vinyl format on Pinorama Records.\n\nHe is currently researching new sounds and themes for his second album, while also working on collaborations and music productions with other artists.",
